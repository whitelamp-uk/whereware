...
('whereware', 'whereware-server', '\\Whereware\\Whereware', 'skuUserUpdate',  2,  'SKU name', 0,  'varchar-64'),
...
('Whereware', 'wwSkuInsert', 'Insert a new SKU'),
...
('Whereware', 'wwMoveAssign', 3,  'Project code', 0,  'varchar-64'),
('Whereware', 'wwMoveAssign', 4,  'Task ID', 0,  'int-11-positive'),
('Whereware', 'wwMoveAssign', 5,  'Team code', 0,  'varchar-64'),
...
('Whereware',	'wwMoveInsert',	7,	'From location',	0,	'varchar-64'),
('Whereware',	'wwMoveInsert',	8,	'From bin',	1,	'varchar-64'),
('Whereware',	'wwMoveInsert',	9,	'To location',	0,	'varchar-64'),
...
('Whereware', 'wwSkuInsert',  2,  'Bin', 1,  'varchar-64'),
('Whereware', 'wwSkuInsert',  3,  'Additional_ref', 1,  'varchar-64'),
('Whereware', 'wwSkuInsert',  4,  'Unit_price', 0,  'currency-pos'),
('Whereware', 'wwSkuInsert',  5,  'Name', 1,  'varchar-64'),
('Whereware', 'wwSkuInsert',  6,  'Notes', 1,  'varchar-4096'),
...
('Whereware', 'wwSkuUpdate',  5,  'Name', 1,  'varchar-64'),
