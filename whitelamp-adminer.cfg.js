...
var whitelampAdminer = {
    barcode : {
        columns : [
            ...
            ['whereware','ww_project_sku','project'],
            ['whereware','ww_project_sku','sku'],
            ['whereware','ww_recent_inventory','sku'],
            ['whereware','ww_recent_inventory','sku_alt_code'],
            ['whereware','ww_recent_inventory','location'],
            ['whereware','ww_recent_inventory','bin'],
            ['whereware','ww_sku','sku'],
            ['whereware','ww_sku','alt_code'],
            ['whereware','ww_task','team'],
            ['whereware','ww_task','location'],
            ['whereware','ww_task','scheduled_date'],
    ...
    columnFade : {
        columns : [
            ...
            ['whereware','ww_movelog','log_id'],
            ['whereware','ww_movelog','move_id'],
            ['whereware','ww_project','id'],
            ['whereware','ww_project_sku','id'],
            ['whereware','ww_sku','id'],
            ['whereware','ww_status','id'],
            ['whereware','ww_task','id'],
    ...
    inputConstraint : {
        ...
        //  ['db_name','table_name','column_name','pattern_name'],
            ...
            ['whereware','ww_project_sku','sku','code'],
            ['whereware','ww_status','status','status'],
            ['whereware','ww_sku','sku','code'],
            ['whereware','ww_task','team','code'],
            ['whereware','ww_task','location','code'],
